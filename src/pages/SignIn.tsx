...
export const SignIn = () => {
    return(
        <section className="w-full h-screen bg-bgSignIn bg-cover bg-center flex justify-center items-center bg-blend-color bg-[#000000d3]">
            ...
            <h1 className="font-bold text-3xl mb-10 text-center text-white">Rest<span className="text-red-900">App</span></h1>
                <form className="flex flex-col gap-4 ">
                    ...
                    <div className=" flex items-center gap-4 ">
                        <button className="rounded py-2 bg-gray-900 opacity-80 text-white w-full hover:opacity-100">Login</button>
